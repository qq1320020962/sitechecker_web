...
<body>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<p class="text-danger">发布时间：${inspect.publish_time }</p>
									...
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											<div class="modal-header">
												...
												<h4 class="modal-title" id="myModalLabel">${picture.img_name }</h4>
											</div>
											<div class="modal-body">
												<img src="${picture.url }">
												<p class="text-muted">图片备注：${picture.remark }</p>
												<p class="text-primary">上传者：${picture.user.username }</p>
												<p class="text-danger">上传时间：${picture.publish_time }</p>
